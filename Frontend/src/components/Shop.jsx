      ...
      <div className="flex flex-row  justify-start items-start  pl-12 pr-12 gap-10 ">
        ...
        <div className="flex flex-col items-center justify-start w-[65%]  gap-10">
          <div className="flex flex-col items-center justify-start w-full gap-[30px]">
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2  w-full  gap-3  lg:gap-5">
              <button className="text-black py-2 px-0  lg:px-10 font-medium min-w-[150px] rounded-[10px] bg-orange-400">
                All Books
              </button>
              <button className="text-black bg-white py-2 px-0  lg:px-10 font-medium min-w-[150px] rounded-[10px]">
                Kindergarten
              </button>
              <button className="text-black bg-white py-2 px-0   lg:px-10 font-medium min-w-[150px] rounded-[10px]">
                High School
