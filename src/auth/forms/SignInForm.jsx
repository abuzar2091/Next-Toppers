...
function SignInForm() {
  ...
  return (
    <div className="flex shadow-custom rounded-3xl bg-white   justify-around  absolute top-1/2 left-1/2  transform translate-x-[-50%] translate-y-[-50%] z-100 border-4  border-gray-400">
      <div className="flex flex-col gap-4 ml-12 py-16 w-[280px]">
        <img src="/assets/icons/logo.svg" className="px-0" />

        <h1 className="font-bold text-2xl w-[250px] ">
          Welcome to
          <br />
          FreeLanceIT Online
          <br />
      ...
      <div className="px-16 py-4 w-[400px]">
        <div className=" text-lg border-2 border-gray-200 mt-16 rounded-md h-12 ">
          <div
