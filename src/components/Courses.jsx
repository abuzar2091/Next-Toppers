  ...
  return (
    <div className="flex flex-col  justify-start w-full gap-[50px] bg-gray-100 ">
      <div className="flex flex-col items-start justify-start  mx-12 my-8 gap-[5px] p-5 md:px-5 bg-yellow-100 max-w-7xl rounded-[20px]">
        ...
        <div className="flex flex-row  justify-between items-center w-[99%]  ml-2.5 gap-[436px] md:gap-10 md:ml-0">
          <h1 className=" text-[45px]  !font-semibold   w-1/2">
      ...
      <div className="flex flex-col items-center justify-start w-full gap-[47px]">
        <div className="flex flex-row  justify-center w-full gap-5  max-w-7xl">
          <button
            color="white_A700"
            className=" bg-white text-gray-900  py-2  font-medium min-w-[120px] rounded-[10px]"
          >
            All Courses
          </button>
          <button className="bg-white text-gray-900  font-medium min-w-[142px] rounded-[10px]">
            Kindergarten
          </button>
          <button className="bg-orange-300 text-white font-medium min-w-[120px] rounded-[10px]">
            High School
          </button>
          <button className="bg-white text-gray-900   font-medium min-w-[120px] rounded-[10px]">
            College
          </button>
          <button className="bg-white text-gray-900  font-medium min-w-[142px] rounded-[10px]">
            Computer
          ...
          <button className="bg-white text-gray-900    text-deep_orange-400 font-medium min-w-[142px] rounded-[10px]">
            More Courses
          </button>
        </div>
        <div className="flex flex-row justify-center mx-12 my-8">
          <div className="flex flex-col items-start justify-start w-full gap-[23px] md:px-5 max-w-7xl">
            ...
            <div className="flex flex-row justify-center w-full">
              <div className="w-full grid gap-10 grid-cols-4  justify-center md:gap-5">
