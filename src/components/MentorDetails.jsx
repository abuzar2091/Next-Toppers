...
function MentorDetails() {
  return (
    <div className="flex flex-col justify-center w-full bg-gray-100 ">
      <div className="flex flex-row justify-center w-full md:px-12  py-8 max-w-7xl">
      ...
      <div className="flex flex-row justify-center w-full">
        <div className="flex flex-row  justify-start items-start w-full gap-10 md:gap-5 px-12 max-w-7xl">
          <div className="flex flex-col  justify-start w-[66%]  gap-[29px]">
            ...
            <div className="flex flex-row  justify-start w-[79%]  gap-[19px] ">
              ...
              <button className="sm:px-5 font-medium min-w-[205px] rounded-[10px] bg-white">
                Courses
              </button>
              <button className="sm:px-5 font-medium min-w-[205px] rounded-[10px] bg-white">
                Reviews
              </button>
              <button className=" font-medium min-w-[160px] rounded-[10px] bg-red-300">
                Contact Now
              </button>
            </div>
            {/* </div> */}
          ...
          <div className="flex flex-col items-center justify-center w-[32%]  gap-[19px] p-5 bg-white rounded-[10px]">
